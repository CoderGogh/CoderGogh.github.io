...
tags: [os, process, thread, context-switching, multithreading, virtual-memory, thrashing]
description: 프로그램→프로세스→스레드 흐름, 메모리 구조 비교, 멀티스레드 장단점, 디스패처·문맥 교환, 가상 메모리와 스래싱까지 면접 핵심 개념을 한 번에 정리한 포스트입니다.
---
...
![프로그램에서 프로세스로](https://github.com/user-attachments/assets/27408e47-72f8-4ea5-b3ff-3bb3b045b13c)
...
프로세스
 ├── 스레드 1 ─┐
 ├── 스레드 2 ─┼──→ Code / Data / Heap (공유 메모리 영역)
 └── 스레드 3 ─┘
...
![프로세스 메모리 구조](https://github.com/user-attachments/assets/1ce48e82-2b2e-4ba4-b474-b7f5570b16a6)
...
![스레드 메모리 구조](https://github.com/user-attachments/assets/2e885d0a-075e-4848-ad49-ef824b22a56e)
...
- **통신 부담 적음**: Stack 영역을 제외한 모든 메모리를 공유하기 때문에 통신의 부담이 적어서 응답 시간이 빠르다.
...
![디스패처와 문맥 교환 다이어그램](https://github.com/user-attachments/assets/c62569ad-6488-4af4-9c29-0b9746613d3d)
